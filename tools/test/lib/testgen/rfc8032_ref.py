# Reference code from RFC 8032 document, with minor adjustments and reformatting
# src: https://datatracker.ietf.org/doc/html/rfc8032#appendix-A
...
def sha3_transform(s):
    ...
    PERMUTATION = [1, 6, 9, 22, 14, 20, 2, 12, 13, 19, 23, 15, 4, 24, 21, 8, 16, 5, 3, 18, 17, 11, 7, 10]
...
class Edwards448Point(EdwardsPoint):
    ...
    f0 = base_field.make(0)
    f1 = base_field.make(1)
    xb = base_field.make(hexi('4F1970C66BED0DED221D15A622BF36DA9E146570470F1767EA6DE324A3D3A464'
                              '12AE1AF72AB66511433B80E18B00938E2626A82BC70CC05E'))
    yb = base_field.make(hexi('693F46716EB6BC248876203756C9C7624BEA73736CA3984087789C1E05A0C2D7'
                              '3AD3FF1CE67C39C4FDBD132C4ED7C8AD9808795BF230FA14'))
    ...
    # Order of basepoint.
    def l(self):
        return hexi('3fffffffffffffffffffffffffffffffffffffffffffffffffffffff7cca23e9'
