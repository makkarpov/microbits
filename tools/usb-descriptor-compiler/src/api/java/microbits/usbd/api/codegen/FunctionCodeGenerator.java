...
public interface FunctionCodeGenerator {
    ...
    /**
     * Generate a function configuration structure, using a provided symbol name.
     *
     ...
     */
    @Nullable
    default String generateConfiguration(String symbolName) {
        return null;
    }
}
